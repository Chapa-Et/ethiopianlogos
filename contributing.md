...
## Using the form
You can upload your logos directly to the online form here: https://airtable.com/chapa-logo. This usually takes about 48 hours to be reviewed and merged.
...
3. In **[logos.json](https://github.com/Chapa-Et/ethiopianlogos/blob/master/logos.json)**, add a `JSON` entry for your company
...
If you do so, kindly edit this file; adding the newly used category (**[/contributing.md](https://github.com/Chapa-Et/ethiopianlogos/blob/master/contributing.md)**) in your PR as well.
